...
<html>
<head>
    <title id='dop1'>CONTRAT ESSAI</title>
...
<div class="container-fluid">
    ...
    <h1 style='font-size:20px; text-align:center; font-weight: bold;'>CONTRAT ESSAI</h1>
    <table id="ta">
        <thead>
        <tr>
            <th>Num Ordre</th>
    ...
    <a style='margin-left:5px' href="{{ url('cde_actif') }}" id='dopt'  class="btn btn-default">Retour</a>
